...
for nFag = 1:length(FagList)
    ...
    for nCmprsHlth = 1:length(CmprsHlthList)
        ...
        [AFoutdB1, IOfuncdB1] = GCFBv23_AsymFuncInOut(GCparam,GCresp,Fr1query,CmprsHlth,PindBList);
        if CmprsHlth == 1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Check inverse functions of GCFBv23_AsymFuncInOut.m');
fs   = 48000;
GCparam.fs  = fs;
GCparam.FRange  = [100 12000]; % 8000 Hzまでカバーするため、あえて広く取る
GCparam.NumCh = 100;
...
Fr1 = 100;
CmprsHlth = 1;
[AFoutdB, IOfuncdB] = GCFBv23_AsymFuncInOut(GCparam,GCresp,Fr1,CmprsHlth,PindB);
AFoutdB
IOfuncdB

[PindBinv_IOfunc] = GCFBv23_AsymFuncInOut_InvIOfunc(GCparam,GCresp,Fr1, CmprsHlth,IOfuncdB);
...
%%% 
CmprsHlth05 = 0.5;
[PindBinv_IOfunc05] = GCFBv23_AsymFuncInOut_InvIOfunc(GCparam,GCresp,Fr1, CmprsHlth05,IOfuncdB);
[AFoutdB, IOfuncdB_1] = GCFBv23_AsymFuncInOut(GCparam,GCresp,Fr1,CmprsHlth05,PindBinv_IOfunc05)

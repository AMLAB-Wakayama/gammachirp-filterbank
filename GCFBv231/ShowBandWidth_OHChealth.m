%
%       Show Bandwidth of GCFBv231 as a function of OHC Health
%       Toshio IRINO
...
for nFr1query = 1:length(Fr1queryList) % for comfirmation of none-freq-dependency
    ...
    GCparam.HLoss.HearingLeveldB = 50*ones(1,7); % 50 dB  does not to limit the OHC health
    CmprsHlthList = [0:0.2:1];  % Compression health ==  OHC health
...
NameFig = ['./Fig/Fig_Bandwidth_OHChealth'];
printi(3,0,0.8);
